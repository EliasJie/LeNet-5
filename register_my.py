...
os.system("python ./tools/deploy/export_model.py --config-file ./configs/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml     --output ./output --export-method tracing --format torchscript     MODEL.WEIGHTS ./output/model_final.pth  MODEL.DEVICE cpu")